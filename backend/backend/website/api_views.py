...
from website.models import AboutSection, AdvisoryLike, AdvisoryPriceTerm, AdvisoryRating, AdvisoryService, AdvisoryServiceImage, AdvisoryServiceType, Article, Category, Customer, FooterMenuContent, PartnerOrganization, Slide, Software, SoftwareImage, SoftwareRating
...
def my_ratings_api(request: HttpRequest) -> JsonResponse:
    ...
    advisory_ratings = (
        ...
        .filter(user=request.user)
        .select_related("advisory_service")
    )
