...
import {createAdvisory, createArticle, createSoftware, deleteAdvisory, deleteArticle, deleteSoftware, getAdvisories, getAdvisoryDetail, getArticleDetail, getArticles ,getMyRatings, getSoftwareDetail, getSoftwares, MyRatingItem, updateAdvisory, updateArticle, updateSoftware,deleteSoftwareRating, deleteAdvisoryRating, }from "../api/website";
...
export function ProfilePage({
  ...
  const isOrganization = profile.account_type !== "person";
  const [activeTab, setActiveTab] = useState<(typeof tabItems)[number]["id"]>("overview");
  ...
  useEffect(() => {
    if (!isOrganization && (activeTab === "overview" || activeTab === "contact" || activeTab === "account")) {
      setActiveTab("reviews");
    }
  }, [isOrganization, activeTab]);
      ...
      <div className="profile-software-intro">
        <div className="profile-software-intro-actions">
          {isOrganization ? (
            ...
            <p className="profile-software-empty">Зөвхөн байгууллагын бүртгэлтэй хэрэглэгч програм хангамж нэмэх боломжтой.</p>
          )}
        </div>
      </div>
      ...
      <div className="profile-software-intro">
        <div className="profile-software-intro-actions">
          {isOrganization ? (
            ...
            <p className="profile-software-empty">Зөвхөн байгууллагын бүртгэлтэй хэрэглэгч зөвлөх үйлчилгээ нэмэх боломжтой.</p>
          )}
        </div>
      </div>
      ...
      <div className="profile-software-intro">
        <div className="profile-software-intro-actions">
          {isOrganization ? (
            ...
            <p className="profile-software-empty">Зөвхөн байгууллагын бүртгэлтэй хэрэглэгч нийтлэл нэмэх боломжтой.</p>
          )}
        </div>
      </div>
  ...
  <div className="profile-card profile-sidebar-card">
    ...
    <div className="profile-sidebar-user">
      ...
      <span className={`profile-account-badge ${isOrganization ? "is-org" : "is-person"}`}>
        {isOrganization ? "Байгууллага" : "Хувь хэрэглэгч"}
      </span>
    </div>
  ...
  <div className="profile-card profile-card-main">
    ...
    {activeTab === "overview" ? (
      ...
      <div className="profile-payment">
        <div className="profile-payment-dashboard">
          <div className="profile-payment-heading">
            <div>
              <span className="profile-payment-label">НИЙТ ҮЛДЭГДЭЛ</span>
              <h2>₮0</h2>
            </div>

            <button type="button" className="profile-payment-add">
              + Цэнэглэх
            </button>
          </div>
          ...
          <div className="profile-payment-summary">
            <div>
              <span>Энэ сарын төлбөр</span>
              <strong>₮0</strong>
            </div>

            <div>
              <span>Нийт гүйлгээ</span>
              <strong>0</strong>
            </div>
          </div>
        </div>
