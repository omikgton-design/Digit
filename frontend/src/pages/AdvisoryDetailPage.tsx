...
import { getAdvisoryDetail, saveAdvisory, rateAdvisory } from "../api/website";
        ...
        <div className="software-detail-layout">
          ...
          <aside className="software-detail-sidebar">
            <div className="software-detail-card">
              ...
              <button type="button" className="login-submit" style={{width:"auto", marginBottom:16}} onClick={async()=>{try{await saveAdvisory(item.id);window.alert("Хадгаллаа.");}catch(e){window.alert((e as Error).message || "Хадгалахад алдаа гарлаа.");}}}>Хадгалах</button>
